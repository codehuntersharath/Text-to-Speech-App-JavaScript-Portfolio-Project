...
# 🗣️ Text to Speech App — JavaScript Portfolio Project

![JavaScript](https://img.shields.io/badge/JavaScript-ES6-yellow)
![HTML](https://img.shields.io/badge/HTML5-Markup-orange)
![CSS](https://img.shields.io/badge/CSS3-Styling-blue)

A **Text-to-Speech application built using Vanilla JavaScript** and the **Web Speech API**, designed as a real-world frontend portfolio project showcasing browser-native capabilities.
...
[![Watch the video](https://img.youtube.com/vi/5a9qs3NWUqg/maxresdefault.jpg)](https://youtu.be/5a9qs3NWUqg)
...
Browser APIs are often ignored — but highly valuable.

This project demonstrates:
- JavaScript Web API usage
- Speech synthesis fundamentals
- UI + logic integration
- Clean, interview-ready frontend code

A strong **differentiator project** in any frontend portfolio.

---

## ✨ Features
- Convert text to speech instantly
- Multiple browser-supported voices
- Control pitch & speech rate
...
1. User enters text
2. JavaScript accesses SpeechSynthesis API
3. Browser provides available voices
4. Speech settings are applied
5. Text is converted into audible speech

---

## 🎯 Learning Outcomes

- Use browser-native JavaScript APIs
- Understand speech synthesis logic
- Improve DOM & event handling
- Build unique portfolio projects
- Gain confidence beyond frameworks
